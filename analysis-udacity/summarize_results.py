...
if __name__ == "__main__":
    ...
    with open('summary.txt', 'wt') as out:
        ...
        mutants_having_crashes_obes_on_all_model = \
            pd.read_csv('results(csv)/mutant_list_having_crashes_or_obes_on_all_models.csv')['mutation'].tolist()
        ...
        df_mutants_killed_info = pd.concat([pd.read_csv('results(csv)/killed_info_of_mutants_for_no_crashes_obes.csv'),
                                            pd.read_csv(
                                                'results(csv)/killed_info_of_mutants_for_some_crashes_obes.csv')])
        ...
        df_comparison_model_system = pd.concat(
            [pd.read_csv('results(csv)/Comparison_with_model_level_of_mutants_for_no_crashes_obes.csv'),
             pd.read_csv('results(csv)/Comparison_with_model_level_of_mutants_for_some_crashes_obes.csv')])
