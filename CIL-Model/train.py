#from gpu_config import limit_gpu_use,disable_gpu_use
#disable_gpu_use()
import numpy as np
import glob
import h5py
...
def train_CIL(args):
    # Load Dataset
    trainPath = '/Users/nimishamanjali/Desktop/CIL-Keras/dataset/SeqTrain/'
    valPath = '/Users/nimishamanjali/Desktop/CIL-Keras/dataset/SeqVal/'
    ...
    masks = [1, 2, 3, 4, 5]
    # Generator
    def batch_generator(file_names, batch_size = 6):
        ...
        while True:
            for i in range(batch_size - 1):
                ...
                #print('file_________________________')
                #print(trainFile[file_idx])
    ...
    def CIL(input_image, input_speed, weights_path = None):
        ...
        model = Model(inputs=[xs, sm], outputs=branches)
    ...
    model = CIL(input_image, input_speed, weights_path)
